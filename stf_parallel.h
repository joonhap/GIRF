...
class stf {
 public:
  ...
  std::vector<double> imdmeasure(int t, int s, std::vector<int> lookaheads, int im, const std::vector<state_T>& state, const std::vector<std::vector<obs_T> >& meas, const std::vector<double>& theta, std::vector<std::vector<std::vector<double> > >& forecast_var, bool logarithm); // imdmeasure with lookahead steps, using stored forecast variability estimates
  double imdmeasure(int t, int s, int im, const std::vector<state_T>& state, const std::vector<obs_T>& meas, const std::vector<double>& theta, std::vector<std::vector<double> >& forecast_var, bool logarithm); // default lookahead = 1, using stored forecast variability estimates
